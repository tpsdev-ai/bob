...
//
// These two types are the contract the discord.js binding (DiscordJsClient)
// implements and the discord capability (src/capabilities/discord)
...
// the shell stays importable without discord.js for agents that don't need it —
// discord.js is only ever pulled in when the discord capability is loaded.
...
export interface DiscordClient {
  ...
  // heartbeat in the discord capability.
  //
