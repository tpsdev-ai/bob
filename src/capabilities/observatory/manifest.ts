// Bob manifest for the observatory capability — the thin Bob-side metadata pi doesn't
...
// agent's bob.yaml `observatory:` block against the very object the extension
...
export const observatoryManifest: BobCapabilityManifest = {
  name: "observatory",
  piPackage: "@tpsdev-ai/bob/capabilities/observatory",
